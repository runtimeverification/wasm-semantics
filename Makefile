...
tests/proofs/memory-concrete-type-spec.k%prove: PROVE_OPTIONS=--z3-tactic "(or-else (using-params smt :random-seed 3 :timeout 2000) (using-params smt :random-seed 2 :timeout 4000) (using-params smt :random-seed 0))" --z3-impl-timeout 12000 --debug-z3-queries
