...
tests/proofs/functions-spec.k.prove: KPROVE_OPTS   = --concrete-rules WASM-DATA.setRange-Positive,WASM-DATA.getRange-Positive
tests/proofs/memory-spec.k.prove:    KPROVE_OPTS   = --concrete-rules WASM-DATA.setRange-Positive,WASM-DATA.getRange-Positive
