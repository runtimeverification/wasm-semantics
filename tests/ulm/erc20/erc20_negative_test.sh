...
function test_transfer_too_much {
  ...
  erc20_transfer $k2 $contract $a3 $(to_hex 600)
  echo -n "."

  balance2=$(erc20_balanceOf $k1 $contract $a2)
  echo -n "."
  assert_eq "400" "$balance2" "Balance of Account 2"

  balance3=$(erc20_balanceOf $k1 $contract $a3)
  echo -n "."
  assert_eq "600" "$balance3" "Balance of Account 3"
...
function test_transfer_too_much_from {
