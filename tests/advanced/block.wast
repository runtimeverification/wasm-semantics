...
(module
  ...
  (func (export "break-inner") (result i32)
    ...
    ;;r (local.set 0 (i32.add (local.get 0) (block (result i32) (block (result i32) (br 1 (i32.const 0x1))))))
    (local.set 0 (i32.add (local.get 0) (block (result i32) (block (result i32) (br 1 (i32.const 1))))))
    ;;r (local.set 0 (i32.add (local.get 0) (block (result i32) (block (br 0)) (i32.const 0x2))))
    (local.set 0 (i32.add (local.get 0) (block (result i32) (block (br 0)) (i32.const 2))))
    (local.set 0
      ;;r (i32.add (local.get 0) (block (result i32) (i32.ctz (br 0 (i32.const 0x4)))))
      (i32.add (local.get 0) (block (result i32) (i32.ctz (br 0 (i32.const 4)))))
    )
    (local.set 0
      ;;r (i32.add (local.get 0) (block (result i32) (i32.ctz (block (result i32) (br 1 (i32.const 0x8))))))
      (i32.add (local.get 0) (block (result i32) (i32.ctz (block (result i32) (br 1 (i32.const 8))))))
    )
    (local.get 0)
  )
...
;;r (assert_return (invoke "break-inner") (i32.const 0xf))
(assert_return (invoke "break-inner") (i32.const 16))
